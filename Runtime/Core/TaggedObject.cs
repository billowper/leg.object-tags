...
namespace LowEndGames.ObjectTagSystem
{
    ...
    public class TaggedObject : MonoBehaviour, ITagOwner
    {
        ...
        public void AddTagsWhile(IEnumerable<ObjectTag> tags, CancelToken cancelToken) => m_tagOwner.AddTagsWhile(tags, cancelToken);

        public void BlockTagsWhile(IEnumerable<ObjectTag> tags, CancelToken cancelToken) => m_tagOwner.BlockTagsWhile(tags, cancelToken);
